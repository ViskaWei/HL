...
# HESSIAN_PATH = "/home/swei20/HL/dataset/flux3d.h5"
...
Lg_paras = np.array([0., 0.5, 1., 1.5, 2. , 2.5, 3. , 3.5, 4. , 4.5, 5. ])
...
Te_paras = np.array([ 3500.,  3750.,  4000.,  4250.,  4500.,  4750.,  5000.,  5250.,
